...
void ui_DescriptionScreen_screen_init(void)
{
    ...
    ui_SettingsButton2 = lv_btn_create(ui_DescriptionScreen);
    lv_obj_set_width(ui_SettingsButton2, 50);
    lv_obj_set_height(ui_SettingsButton2, 50);
    lv_obj_set_x(ui_SettingsButton2, 310);
    lv_obj_set_y(ui_SettingsButton2, -215);
    ...
    lv_obj_set_style_bg_opa(ui_SettingsButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_SettingsButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_SettingsButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_SettingsImage2 = lv_img_create(ui_SettingsButton2);
    lv_img_set_src(ui_SettingsImage2, &ui_img_settings_png);
    lv_obj_set_width(ui_SettingsImage2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_SettingsImage2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_SettingsImage2, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_SettingsImage2, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_SettingsImage2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_img_set_zoom(ui_SettingsImage2, 180);

    ui_WifiButton2 = lv_btn_create(ui_DescriptionScreen);
    lv_obj_set_width(ui_WifiButton2, 50);
    lv_obj_set_height(ui_WifiButton2, 50);
    lv_obj_set_x(ui_WifiButton2, 250);
    lv_obj_set_y(ui_WifiButton2, -215);
    ...
    lv_obj_set_style_bg_color(ui_WifiButton2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_WifiButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_WifiButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_WifiButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_WifiImage2 = lv_img_create(ui_WifiButton2);
    lv_img_set_src(ui_WifiImage2, &ui_img_wifi_png);
    ...
    ui_PowerButton2 = lv_btn_create(ui_DescriptionScreen);
    lv_obj_set_width(ui_PowerButton2, 50);
    lv_obj_set_height(ui_PowerButton2, 50);
    lv_obj_set_x(ui_PowerButton2, 370);
    lv_obj_set_y(ui_PowerButton2, -215);
    ...
    lv_obj_set_style_bg_color(ui_PowerButton2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_PowerButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui_PowerButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_spread(ui_PowerButton2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_PowerImage2 = lv_img_create(ui_PowerButton2);
    lv_img_set_src(ui_PowerImage2, &ui_img_power_png);
    lv_obj_set_width(ui_PowerImage2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_PowerImage2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_PowerImage2, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_PowerImage2, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_PowerImage2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_add_event_cb(ui_PowerButton2, ui_event_PowerButton2, LV_EVENT_ALL, NULL);
